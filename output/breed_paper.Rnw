...
crops. However, many production systems are experiencing plateaus in grain
...
implications~\citep{Foley2011a}. Therefore, it is of critical importance to better
...
with yields on average increasing by about 50 to 62 kg ha-1 between
1999 and 2014.
...
popular cultivar M-202 was
released in 1985, it was reported to yield an average of 11 Mg
ha\tsups{-1} \citep[14\% moisture content (MC);][]{m202}. In 2015, the
reported average yield of the newest released cultivar M-209 was
10.8 Mg ha\tsups{-1} \citep[14\% MC;][]{m209}. However, in annual
breeding reports and varietal release announcements, based on yield
performance in side-by-side variety trails, data show that new
varieties usually out yield the older varieties. In other rice
systems, a decrease in a cultivar's yield performance over time has
been observed \citep{Peng1998, Peng2010, Peng2000, Datta1995}, often
termed yield erosion \citep{Peng1998}. It has been speculated that
this yield erosion is due to the inability of a cultivar to adapt to
changing biotic and abiotic conditions~\citep{Peng1998, Peng2010,
Peng2000, Datta1995}. Yield erosion may explain the apparent
contradiction above, in which side-by-side yield comparisons show
yield improvements in varieties while overall there may be little
change in yield potential. To address this issue we teseted the
hypothesis that if rice cultivar yields erode over time then apparent
yield increases in side-by-side yield comparison tests will not
reflect true yield increases.
...
90\% of the planted rice area in CA. Newly developed entries are typcically
...
(average 3 years) in the experimental trials confirmed that genetic
yield improvements have been consistant over the 30 year study period
(Fig. \ref{fig:first_yrs}). As estimated by the model including both
yield erosion and yield improvement over time, there is no conclusive
evidence that the yields of medium grain rice cultivars selected and
released by CCRRF's breeding program have, on average, increased over
the last 30 years (Table \ref{tbl:coef}). The full model which
corrected for both the year of release and yield erosion was estimated
to have better out-of-sample predictive accuracy compared to reduced
models containing only one predictor (See supplemental material for
further details). The estimated change in grain yield per year in the
CCRRF's breeding trials at the RES was estimated to be a negligible
...
estimate is flawed (i.e., it ignores the confounding effect of yield
erosion over time and performed worse in out-of-sample predictive
accuracy), it confirms previous analyses of side-by-side comparisons
which concluded that newer cultivars out-preform older ones.
...
\caption{The relationship between yield and the years since release
  for medium grain rice cultivars. The estimated erosion of yield over time
...
its release. The two most dominate medium grain rice cultivars, M-202
(widely planted from the late 1980s until the early 2000s) and M-206
(currently the most widely planted), experienced
...
has likely maintained but not substantially improved the yield
...
physiological limit \citep{espe16a}. Without maintenance breeding
...
Fig. \ref{fig:ids_comp})) are not widely adapted. It is known that
