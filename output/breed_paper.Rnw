...
research). However, since 1990 the rate of increase has slowed
(Fig. \ref{fig:state_yield}) despite continuous crop improvement
\citep{ccrrf}. For the past 30 years, each newly developed cultivar
has demonstrated a yield advantage over the previous cultivars in the
Statewide Variety Trials (an annual multi-site variety trial program
that compares experimental entries side-by-side with ``check''
cultivars). However, in a seeming contradiction these same reports
show stagnant yields across release announcements (i.e., reports
accompanying the official public release) from the previous years. For
example, when cultivar M-202 was released in 1985, it was reported to
yield an average of 11 Mg ha\tsups{-1} \citep[14\% moisture content
(MC);][]{m202}. In 2015, the reported average yield of the newest
released cultivar M-209 was 10.8 Mg ha\tsups{-1} \citep]14\%
MC;][]{m209}. In other rice systems, a decrease in a cultivar's yield
...
a cultivar to adapt to changing biotic and abiotic conditions. To
better understand how plant improvement and yield erosion are
contributing to the improvement of rice yield in farmers' fields, we
teseted the hypotheses: either (1) the genetic yield advantage
increased over the last 30+ years, or (2) the genetic yield advantage
has not increased over the last 30+ because the erosion of yield over
time creates an illusion of improved yields.
...
\caption{The experimental yield of medium grain rice varieties for the
...
predominate varieties grown in CA, and while their yield potentials
...
(shorter duration varieties would presumably require less irrigation
water). 
