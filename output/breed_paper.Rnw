...
\Sexpr{round(fixef(RES_yrs_fit)[2] * scl, 1)} lbs
year\textsuperscript{-1}. The oldest cultivar in the trials has lost
an estimated \Sexpr{round(fixef(RES_yrs_fit)[2] * scl * 36 , 1)} kg ha\textsuperscript{-1} since release. Using just data from the Rice
Experiment Station (RES), the estimated effect is more drastic
(an estimated \Sexpr{round(fixef(RES_yrs_fit)[2] * scl , 1)} kg
