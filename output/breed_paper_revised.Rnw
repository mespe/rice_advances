...
Based on Model 3, there was no evidence of consistent differences between cultivars in
the rate of yield decline over time (i.e., all cultivar specific rates
of decline overlapped with eachother and zero). Differences between cultivars in the decline
