...
the rate of yield erosion (Model 3), hence the model excluding varying
...
in yield over time (i.e., yield erosion) once a cultivar was selected
...
accounts for both the year of release and yield erosion indicates that
...
which does not account for yield erosion (Model 2)
