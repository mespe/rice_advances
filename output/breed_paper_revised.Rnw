...
the time of release, M-202 yields were reported at 11.0 Mg ha\tsups{-1}~\citep{m202} which is almost identical to what we . This value of
11.0 Mg ha\tsups{-1} is what we also found in this analysis based on the
average experimental yields prior to public release (Fig. \ref{fig:first_yrs}). Since
the release of M-202, the rice yields of newly released varieties
cultivars have remained between 10.8 and 11.5 Mg ha\tsups{-1} (Fig. \ref{first_yrs}),
with the exception of M-204 and M-205 (M-204 is no longer grown and
M-205 has limited adoaptation range so is only grown in a limited
area). The variety cultivar M-206 was released in 2004 and is
currently still the most widely grown rice varietycultivar in
California. At the time of its release, M-206 was reported to yield
\Sexpr{round(9350*1.12,1)}
Mg ha\tsups{-1} -- also similar to what we found based on our analysis (Fig. \ref{fig:first_yrs}). Based on this premise, it is clear that improvements
in yield potential have not been made over the 33-yr period of this
study. In contrast, both~\citet{Omar2014} and ~\citet{mckenzie2014}, report yield potential gains in California rice systems
based on analyses that showed
that newly released cultivars had higher yields than previously
released cultivars. Based on their
analyses,~\citet{Omar2014} reported yield gains from the rice
breeding program of 37 to 60 kg ha\tsups{-1} yr\tsups{-1} and ~\citet{mckenzie2014} a
yield increase of 25 kg ha\tsups{-1} yr\tsups{-1}. Using a similar
approach to~\citet{Omar2014} and ~\citet{mckenzie2014}, when the compared average yields
for the period 2011--2016 of varieties cultivars released since 1982 (and still in
the variety trials from 2011-- 2016) was compared without accounting
for yield declines over time, yields were
estimated to increase by \Sexpr{only_release_coef} kg ha\tsups{-1}
yr\tsups{-1} (Fig. \ref{fig:wo_erosion}), almost identical to what
~\citet{mckenzie2014}.

The only way to reconcile the two apparently
contradictory findings, is that the yield of potential of varieties
cultivars decline over time such that when newly released varieties
cultivars are compared with the older variety cultivar (as shown by
~\citet{Omar2014}, ~\citet{mckenzie2014}, and Fig. \ref{fig:wo_erosion}), yields of
the new cultivar variety are higher. Here we provide evidence that
cultivar varietal yield does decline - on average at a rate of \Sexpr{yrs_coef} kg
ha\tsups{-1} yr\tsups{-1} (Fig. \ref{w_erosion}). ~\citet{Peng2010} also found that a cultivar’s
varieties yield potential declines over time and reported a 15\%
decline over a 30 yr period.  In this study, over a 30 year period
and a \Sexpr{yrs_coef} kg ha\tsups{-1} yr\tsups{-1} yield decline rate, the yield
decline would be approximately
\Sexpr{round((yrs_coef*-30)/mean(mod_data$yield_kg), 3)*100}\%.

Not accounting for yield decline over time, the estimated yield
improvement of \Sexpr{only_release_coef} kg ha\tsups{-1}
year\tsups{-1} (Fig. \ref{fig:wo_erosion}) is lower than the 37 to 60
kg ha\tsups{-1} year\tsups{-1} estimated by~\citet{Omar2014} in
side-by-side comparisons. To evaluate if 37 to 60 kg ha\tsups{-1}
year\tsups{-1} is reasonable, the potential yields at
the beginning and end of the study period can be compared. ~\citet{vanIttersum2013} defined potential
yield as the yield of optimum management and well-adapted cultivars given
current environmental limitations. Under this definition, potential yield
could be reasonably estimated from the yields of 'M-202' and 'M-206'
in experimental plots at the RES in the years 1984 and 2015,
respectively. Given these criteria, it is clear that potential yield
has changed little over the study period
(Fig. \ref{fig:first_yrs}). When accounting for yield decline over
time across all cultivars, there is no conclusive evidence of
increased genetic yield potential in medium grain rice cultivars
released by CCRRF's breeding improvement program over the period
\Sexpr{min(mod_data[,'year'])} to \Sexpr{max(mod_data[,'year'])}.
Grain yield over this period has stayed relatively constant at an
average \Sexpr{round(mean(mod_data[,"yield_kg"])/1000, 1)} Mg
...
face of changing biotic and abiotic pressures. This conclusion holds
true even when evaluating the cultivars which have been breed for
broad adaption and high yield potential (M-202, M-206 and
M-105). Yields of these cultivars at time of release have all yielded
between
...
in this situation as ~\citet{espe2017} found no substantial changes in
...
declines over time~\citep{Peng1998, Peng2000, Peng2010, Mackay2011}. However, it is not clear
...
for pest and disease pressure. More data is needed to further explore
the exact cause of the yield declines observed here, as well to
determine if different cultivars have differential declines over time.
...
should be made to identify the cause of yield decline over time, this study highlights
