...
side-by-side comparisons. ~\citet{vanIttersum2013} defined potential
yield as the yield of optimum management and cultivars given
environmental limitations. Under this definition, potential yield
...
erosion~\citep{Peng1998, Peng2000, Peng2010, Mackay2011}. However, it is not clear
